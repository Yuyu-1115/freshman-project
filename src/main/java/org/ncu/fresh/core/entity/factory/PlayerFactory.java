...
import org.ncu.fresh.core.constant.ApplicationConfig;
import org.ncu.fresh.core.entity.EntityType;
import org.ncu.fresh.core.entity.component.attack.SpinningProjectileComponent;
...
public class PlayerFactory implements EntityFactory {
    ...
    public static Entity createPlayer() {
        Entity player = FXGL.entityBuilder()
                ...
                .with(new SpinningProjectileComponent(3, 10, 2, 2 * ApplicationConfig.TILE_SIZE))
