...
public class UpgradeUIController implements UIController {
    ...
    public void updateOption(int level) {
        // First weapon
        if (level == 1 || RandomizationHelper.getUpgradableComponent().isEmpty()) {
            ...
            UIHelper.createUpgradeOption(((Weapon)options.get(0)).getWeaponData(), option1);
            UIHelper.createUpgradeOption(((Weapon)RandomizationHelper.rollUpgradableWeapon()).getWeaponData(), option2);
            ...
            ArrayList<Component> options = RandomizationHelper.rollUpgradableWeapon(2);
            UIHelper.createUpgradeOption(((Weapon)options.get(0)).getWeaponData(), option1);
            UIHelper.createUpgradeOption(((Weapon)RandomizationHelper.rollUpgradableWeapon()).getWeaponData(), option2);
            UIHelper.createUpgradeOption(((Weapon)options.get(1)).getWeaponData(), option3);
        }
